---
title: Synthwave 专辑《Scandroid》全鉴赏
...
2013 年 8 月 6 日，单曲《Salvation Code》在 Klayton 的厂牌 FiXT Music 旗下正式发行。

<div align="center">
<meting-js id="2651354" server="netease" type="album"></meting-js>
</div>

同年 11 月，Scandroid 推出第二首先行单曲《Datastream》。

<div align="center">
<meting-js id="2735260" server="netease" type="album"></meting-js>
</div>
...
## Klayton 与 FiXT Neon：从工业摇滚到赛博合成

数年等待之后，Scandroid 同名专辑终于在 FiXT Neon 名义下发行。到本文写作时，《Scandroid》在 YouTube 上的总播放量已接近三百万。凭借 Klayton 在电子摇滚领域的深厚积累和这张专辑本身的完成度与创新性，它对 Synthwave，特别是 Cybersynth 分支的影响非常深远。

与此同时，这张专辑也显著抬升了 FiXT Neon 的行业能见度，使之迅速成为 Cybersynth 代表厂牌之一。
...
- 《The Darkness》
- 《The Light》
- 《The Darkness and The Light》（“再包装”项目）

坊间也有关于新专辑的传闻。

---

## 专辑《Scandroid》：Cybersynth 与摇滚质感的融合

<div align="center">
<meting-js id="34985250" server="netease" type="album"></meting-js>
</div>
...
<meting-js id="440208817" server="netease" type="song"></meting-js>
...
### Salvation Code：人设建立的第一块基石

<meting-js id="440207867" server="netease" type="song"></meting-js>
...
### Aphelion：当机器开始谈论“远日点”

<meting-js id="440208818" server="netease" type="song"></meting-js>
...
### Shout：从 80s 经典到赛博朋克呐喊

<meting-js id="440207868" server="netease" type="song"></meting-js>
...
### Destination Unknown：当“救赎”被证明是幻觉
...
### Connection：在数字海洋中寻找另一个“我”

<meting-js id="440207869" server="netease" type="song"></meting-js>
...
### Datastream：通过数据流完成的邂逅

<meting-js id="440208820" server="netease" type="song"></meting-js>
...
### Empty Streets：空街上的清醒者

<meting-js id="440207870" server="netease" type="song"></meting-js>
...
### Awakening With You：在最底层找到 Aphelion

<meting-js id="440208821" server="netease" type="song"></meting-js>
...
### Atom & E.E.V.：电子版“亚当与夏娃”

<meting-js id="440207871" server="netease" type="song"></meting-js>
...
### Pro-Bots & Robophobes：拥械者与恐械派的对峙
...
<meting-js id="440208823" server="netease" type="song"></meting-js>
...
<meting-js id="440207873" server="netease" type="song"></meting-js>
...
## 总评：一张完成度极高的 Cybersynth 概念专辑

从制作层面而言，《Scandroid》是一张完成度极高的 Cybersynth 专辑：音色设计、结构把握与混音水准都在当时的 Synthwave 圈子里处于第一梯队。

更关键的是，它在“音乐之外”留给听众的空间——每一首歌都像是一段短篇科幻故事的配乐。即使 Klayton 本人的歌词完成度并不算精细，整体听上去却非常统一，几乎可以当作一张完整讲述新东京故事的“概念专辑”来对待。（当然，上文对剧情的串联与细节补完，多为基于粉丝的二次创作，厂牌并未给出官方叙事。）

Scandroid 后续的几张专辑在风格上并未完全复刻这张首专的路径，但整体仍然保持了不俗水准；而他所创建的 FiXT Neon，则在之后数年持续输出高质量作品，吸纳了大量擅长赛博叙事的合成器音乐人。